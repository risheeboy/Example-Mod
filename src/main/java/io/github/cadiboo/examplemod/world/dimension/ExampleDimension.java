...
public class ExampleDimension extends Dimension {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		return new io.github.cadiboo.examplemod.world.dimension.ExampleChunkGenerator(world, new io.github.cadiboo.examplemod.world.dimension.ExampleBiomeProvider(), new io.github.cadiboo.examplemod.world.dimension.ExampleGenSettings());
	}
