...
import io.github.cadiboo.examplemod.world.biomes.ExampleBiome;
import io.github.cadiboo.examplemod.world.biomes.ExampleBiomeSurfaceBuilder;
			...
			.register("example_biome",
					() -> new ExampleBiome(
							new Biome.Builder().precipitation(RainType.SNOW).scale(1.2f).temperature(0.5f)
									.waterColor(16051575).waterFogColor(14280344)
									.surfaceBuilder(
